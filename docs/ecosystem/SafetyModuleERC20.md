...
```solidity
function initialize(string name_, string symbol_, uint256 _cooldown_seconds, uint256 _unstake_window, contract IAddressRegistry _registry) external nonpayable
```
...
| Name | Type | Description |
|---|---|---|
| name_ | string | Name of the token like `Staked Rand Token ERC20` |
| symbol_ | string | Short symbol like `sRND` |
| _cooldown_seconds | uint256 | undefined |
| _unstake_window | uint256 | undefined |
| _registry | contract IAddressRegistry | undefined |
