...
interface IRandToken{
  ...
  function initialize ( string memory name_, string memory symbol_, uint256 _initialSupply, address _registry ) external;
  ...
  function safetyModuleTransfer ( address owner, address recipient, uint256 amount ) external;
