...
interface IAddressRegistry{
  ...
  function getAddressOf ( string memory name ) external view returns ( address contractAddress );
  ...
  function setNewAddress ( string memory name, address contractAddress ) external returns ( bool );
