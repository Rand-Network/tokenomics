...
interface IVestingControllerERC721_V2{
  ...
  function distributeTokens ( bytes memory signature, uint256 signatureTimestamp, address recipient, uint256 rndTokenAmount ) external;
  ...
  function mintNewInvestment ( bytes memory signature, uint256 signatureTimestamp, MintParameters memory params, uint8 nftLevel ) external returns ( uint256 tokenId );
