...
async function getParams() {
    ...
    return {
        ...
        _RegistryAddressbook: {
            _MS: deployer,
            _MS_Final: deployer, // "0x09cD06b1738D9a4568044bA33b60bfdbB9cd7C16",  // Gnosis Safe Mainnet
            _RND: deployer,
            _VCS: deployer, // "0x608b3d5E3cE844faCFF0Be3A9b0D118210AfDcB9",  // OZ Relay Signer
            _SM: deployer,
            _GOV: deployer,
            _RES: deployer //"0xa408C5aeD6021A0FC893532e2CDa3edB035862C6", // Fireblocks Reserves Mainnet
        }
    }
}
