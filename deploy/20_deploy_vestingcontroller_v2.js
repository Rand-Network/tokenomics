...
module.exports = async function (hre) {
    ...
    //await deployments.fixture(['VestingControllerERC721'], { keepExistingDeployments: true });
    ...
    deployments.log("Proxy address:                     ", VestingControllerDeployment.address);
    deployments.log("V1 implementation address:         ", VestingControllerDeployment.implementation);
    deployments.log("V2 implementation address:         ", vc_v2.address);
    ...
    if (hre.network.config.chainId == "31337") {
        ...
        deployments.log("Proxy V2 implementation address:   ", vc_upgraded);
    }
...
module.exports.tags = ["VestingControllerERC721_V2"];
